...
- **图片识别（可选配套）**：配合 [dsh-vision-router](https://www.npmjs.com/package/dsh-vision-router) 插件使用——**DeepSeek 负责推理、视觉模型负责看图**，粘贴图片即可让 AI 识别 / 问答 / 定位；视觉后端可配置为**豆包（Doubao）**等图像理解模型
